    ...
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        public void Configure(SwaggerGenOptions options)
        {
            foreach (var description in _provider.ApiVersionDescriptions)
            {
                ...
                {
                    Version = apiVersion,
                    Title = $"Whs API {apiVersion}",
                    Description = "A simple example ASP Net Core WEwb API. Profwssional way",
                    TermsOfService = new Uri("http://revengston.com"),
                    ...
                    {
                        Name = "IgMo License",
                        Url = new Uri("http://revengston.com")
                    }
                });
